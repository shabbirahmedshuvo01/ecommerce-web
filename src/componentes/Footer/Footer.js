...
const Footer = () => {
    return (
        <div className='mt-5'>
            <footer class="footer p-10 bg-black text-base-content text-white">
                <div>
            ...
            <footer class="footer px-10 py-4 border-t bg-slate-700 text-white text-base-content border-base-300">
